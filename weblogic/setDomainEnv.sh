...
SUN_JAVA_HOME="/usr/java/jdk-11"
export SUN_JAVA_HOME

DEFAULT_SUN_JAVA_HOME="/usr/java/jdk-11"
...
DOMAIN_HOME="/u01/oracle/user_projects/domains/hsoftdev"
export DOMAIN_HOME

LONG_DOMAIN_HOME="/u01/oracle/user_projects/domains/hsoftdev"
